...
> This and other files in this folder are originally from [`jaegertracing/jaeger-client-node`](https://github.com/jaegertracing/jaeger-client-node).
> Some changes has been made to bring them into OTel Jaeger Exporter package. Original folder structure has been kept for easy reference and future changes.
